...
class KACircleCropCutterView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let circle = UIBezierPath(ovalIn: CGRect(x: rect.size.width/2 - (rect.size.width-30)/2, y: rect.size.height/2 - (rect.size.width-30)/2, width: (rect.size.width-30), height: (rect.size.width-30)))
