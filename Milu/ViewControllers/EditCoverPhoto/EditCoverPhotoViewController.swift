//
//  EditCoverPhotoViewController.swift
//  Milu
//
...
protocol EditCoverPhotoViewControllerDelegate
{
...
class EditCoverPhotoViewController: UIViewController,UIScrollViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    var delegate: EditCoverPhotoViewControllerDelegate?
    let cutterView = KARectCropCutterView()
...
//        self.scrollView.center = self.contentView.center
    ...
    @IBAction func backAction(_ sender: Any) {
        self.delegate?.circleCropDidCancel()
    }
