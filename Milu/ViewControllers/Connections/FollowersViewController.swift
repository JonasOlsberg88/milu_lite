...
class FollowersViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,TableViewIndexDelegate {
    ...
    func initData(){
        ...
        sectionDict["a"] = ["austin adams","abe abbot","adam alexander","beau beuler"]
        sectionDict["b"] = ["beau beuler","adam alexander","abe abbot","austin adams"]
...
extension FollowersViewController: SCTableIndexDelegate {
